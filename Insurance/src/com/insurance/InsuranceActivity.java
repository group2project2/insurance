	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		gridview.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                ...
                View dialogView = LayoutInflater.from(InsuranceActivity.this).inflate(R.layout.insurance_detail,null);
		...
		addinsurance.setOnClickListener(new OnClickListener(){                               
			...
			public void onClick(View arg0) {                                               
				...
				lg.addInsurance(InsuranceActivity.this,startdatebtn.getText().toString(),enddatebtn.getText().toString(),instype,userid);                             
			}                                                                            
		});                                                                               
